...
const UserProfile = ({edit}) => {
  ...
  // Fix the photo URL: if it's just "storage", append the actual file name
  const placeholder = "https://via.placeholder.com/150?text=Doctor";
  const photoUrl =
    profile?.photo && profile.photo !== "http://127.0.0.1:8000/storage"
      ? profile.photo
      : placeholder;
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center">
        {!profile?.photo ||
        profile.photo === "http://127.0.0.1:8000/storage" ? (
